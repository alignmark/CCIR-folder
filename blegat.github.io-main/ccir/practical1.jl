...
csv_file = CSV.File("C:/Users/rlime/OneDrive/Documents/CCIR folder/archive/Life Expectancy Data.csv")
...
csv_file = CSV.File("C:/Users/rlime/OneDrive/Documents/CCIR folder/archive/Life Expectancy Data.csv", normalizenames=true)
...
println("Pearson's correlation coefficient R = ", cor(new_df[:, :Life_expectancy], new_df[:, :Alcohol]))
print("Coefficient of determination R^2 = ", cor(new_df[:, :Life_expectancy], new_df[:, :Alcohol])^2)
